...
void CACHE::initialize_replacement()
{
	...
	data_pos = std::stoi(getenv("ITP_INSTR_POS"));
	instr_pos = std::stoi(getenv("ITP_DATA_POS"));
	std::cout << this->NAME << " using diT with max lru@" << maxRRPV << std::endl;
	std::cout << this->NAME << " using diT with instr@" << instr_pos 
